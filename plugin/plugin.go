...
import (
    ...
    _ "github.com/turbot/tailpipe-plugin-kubernetes/sources/audit_logs" // register audit logs row source
    _ "github.com/turbot/tailpipe-plugin-kubernetes/sources/pod_logs"   // register pod logs row source
    _ "github.com/turbot/tailpipe-plugin-kubernetes/sources/events"     // register events row source
